...
test.describe.serial('GB18030', () => {
    ...
    test('创建仪表板', async ({ plusNewPanelPage, workspacePage, page, reportPage }) => {
        ...
        await plusNewPanelPage.ClickCard('Scorecard')
        await scorecardPage.renameScorecard(docbuilder.getShort(8));
        await scorecardPage.inputGoalName(docbuilder.getShort(8));
        await scorecardPage.clickGoalSaveBtn();
        await scorecardPage.newGoal();
        await scorecardPage.inputGoalName(docbuilder.getShort(10));
        await scorecardPage.clickGoalSaveBtn();
        await page.waitForTimeout(5000);
        await scorecardPage.filterGoal(docbuilder.getShort(10));
